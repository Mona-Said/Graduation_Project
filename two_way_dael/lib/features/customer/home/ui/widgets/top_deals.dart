...
class TopDeals extends StatelessWidget {
  const TopDeals({super.key, required this.bestsaleModel2});
  final BestsaleModel bestsaleModel2;
        ...
        return Scaffold(
          ...
          body: GridView.count(
            ...
            children: List.generate(
              bestsaleModel2.data!.length,
              (index) {
                var product = bestsaleModel2.data![index];
                return InkWell(
                  onTap: () {
